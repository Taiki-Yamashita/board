...
<form action="signup" method="post">
	...
	<input name="name" value="${newUser.name}"style="width:400px;height:40px;font-size:20px;" id="name"/>（10文字以下）<br/>

	<label for="account"><p1>ログインID<p1/></label>
	<input name="account" value="${newUser.account}"style="width:400px;height:40px;font-size:20px;"  id="account"/>（半角英数字6文字以上20文字以下）<br/>
	<label for="password"><p1>パスワード<p1/></label>
	<input name="password" value="${newUser.password}" type="password"style="width:400px;height:40px;font-size:20px;"  id="password"/>（半角文字6文字以上255文字以下） <br/>
	<label for="confirmedpassword"><p1>パスワード(確認用)<p1/></label>
	<input name="confirmedpassword"  value="${newUser.confirmedPassword}"style="width:400px;height:40px;font-size:20px;"  id="confirmedpassword"/> <br/>
 ...
 <br />
	<input type="submit"style="width:200px;height:40px;font-size:20px;" value="登録" /> <br /> <br />
</form>
<br/><br/><br/><br/>
